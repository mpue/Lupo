...
public class audioplugin_LupoGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_Lupo"; } }
    public override string Description    { get { return "Lupo"; } }
    ...
    [DllImport("audioplugin_Lupo")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_Lupo")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_Lupo")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_Lupo")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_Lupo")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
